...
import com.kyros.technologies.railapp.adapter.AdminTaskListAdapter;
...
public class AdminTaskListActivity extends AppCompatActivity {
    ...
    private AdminTaskListAdapter adapter;
        ...
        try{
            switch (SubDomain){
                case "CommonArea":
                    ...
                    adapter=new AdminTaskListAdapter(AdminTaskListActivity.this,CommonArea,"Common Area",commonarealist);
                    break;
                case "Passages":
                    try{
                        passageslist.clear();
                    ...
                    adapter=new AdminTaskListAdapter(AdminTaskListActivity.this,Passages,"Passages",passageslist);
                    break;
                case "Tracks":
                    try{
                        trackslist.clear();
                    ...
                    adapter=new AdminTaskListAdapter(AdminTaskListActivity.this,Tracks,"Tracks",trackslist);
                    break;
                case "Lifts":
                    try{
                        liftslist.clear();
                    ...
                    adapter=new AdminTaskListAdapter(AdminTaskListActivity.this,Lifts,"Lifts",liftslist);
                    break;
                case "CirculatingArea":
                    ...
                    adapter=new AdminTaskListAdapter(AdminTaskListActivity.this,CirculatingArea,"Circulating Area",circulatingarealist);
                    break;
                case "Pavements":
                    try{
                        pavementslist.clear();
                    ...
                    adapter=new AdminTaskListAdapter(AdminTaskListActivity.this,Pavement,"Pavement",pavementslist);
                    break;
            }
